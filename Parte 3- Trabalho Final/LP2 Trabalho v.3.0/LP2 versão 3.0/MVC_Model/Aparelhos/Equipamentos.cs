...
namespace MVC_Model
{
    ...
    public class Equipamentos : IVerification, IProcura
    {
        ...
        #region Propriedades
        /// <summary>
        /// Obtém ou ajusta o componente quantidade de Equipamentos
        /// <code>type: int</code>
        /// </summary>
        ...
        /// <summary>
        /// Mostra os dados de um equipamento referente ao id indicado
        /// </summary>
        /// <returns>string</returns>
        ...
        #region Verificaçao
        /// <summary>
        /// Faz uma conversão de um id em string para inteiro, 
        /// caso o valor não esteja correto é enviado uma mensagem
        /// </summary>
        /// <returns>string</returns>
